...
# ########################################################################
# Inicialización (libraries, carga de fichero y preparación de datos):
# ########################################################################

# MXNet: pre-built binary package using CPU (http://mxnet.readthedocs.io/en/latest/how_to/build.html#r-package-installation)
...
model <- mx.model.FeedForward.create(NN_model,
                                     ...
                                     y = train_y,
                                     ctx = devices,
                                     num.round = 480, # default = 10
                                     array.batch.size = 40, # default = 128
                                     learning.rate = 0.01,
                                     momentum = 0.9,
